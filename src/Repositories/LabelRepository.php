...
namespace Luminee\Label\Repositories;
...
class LabelRepository extends BaseRepository
{
    ...
    {
        return $this->setModel('label')->delete($label_id);
    }

    public function deleteLabelByIds($ids)
    {
        return $this->setModel('label')->whereIn('id', $ids)->deleteWhere();
    }

    public function deleteScopeMapById($map_id)
    {
        return $this->setModel('scopeMap')->delete($map_id);
    }

    public function deleteScopeMapByIds($map_ids)
    {
        return $this->setModel('scopeMap')->whereIn('id', $map_ids)->deleteWhere();
    }

    public function deleteScopeMapByLabelId($label_id)
    {
        return $this->setModel('scopeMap')->where('label_id', $label_id)->deleteWhere();
    }

    public function deleteLabelAttributeById($id)
    {
        return $this->setModel('attribute')->delete($id);
    }

    public function deleteLabelAttributeByIds($ids)
    {
        return $this->setModel('attribute')->whereIn('id', $ids)->deleteWhere();
    }

    public function deleteLabelAttributeByLabelId($label_id)
    {
        return $this->setModel('attribute')->where('label_id', $label_id)->deleteWhere();
    }

    public function deleteLabelAttributeByKey($key)
    {
        return $this->setModel('attribute')->where('key', $key)->deleteWhere();
    }
